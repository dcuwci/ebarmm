/**
 * Public Dashboard
 * Overview page with stats and recent projects - mirrors admin Dashboard
 */
...
import { Building2, Zap, CheckCircle, DollarSign, TrendingUp, ClipboardList, Map } from 'lucide-react';
import {
  StatCard,
  Card,
  CardHeader,
